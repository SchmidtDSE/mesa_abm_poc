...
| **Parameters**                   | **Current value** | **Sources, Justifications**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | --- | ----------------------------------------------------------------------------------- |
...
| `JOTR_MAST_YEAR_PROB`            | 0.2               | 2 large flowering events each decade (Borchert & Defalco 2016, page 831)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `JOTR_AGENT_FLOWERING_PROB` | 0.8 | 80 % of trees flower in a large flowering event (Borchert & Defalco 2016, page 831) |
| `JOTR_SEED_MAX_AGE`              | 2                 | 0,1,2 years (Reynolds et al. 2012, page 1651)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 'JOTR_SEED_VIABILITY_LOSS'       | 0.50              | twelve months in the soil reduced germination to 50-68%, and it dropped to less than 1-3% after 40 mo in the soil (Reynolds et al. 2012, page 1651)                                                                                                                                                                                                                                                                                                                                                                                                                        |
