...
| `JOTR_AGENT_FLOWERING_PROB`      |       0.8       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        80% of trees flower in a large flowering event (Borchert & Defalco 2016, page 831) |
| `JOTR_SEED_MAX_AGE`              |        2        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           0, 1, 2 years (Reynolds et al. 2012, page 1651) |
| `JOTR_SEED_VIABILITY_LOSS`       |      0.50       |                                                                                                                                                                                                                                                                                                                                                                                                                   Twelve months in the soil reduced germination to 50-68%, and it dropped to less than 1-3% after 40 months in the soil (Reynolds et al. 2012, page 1651) |
...
| `JOTR_BASE_GERMINATION_RATE`     |      0.004      |                                                                                                                                                                                                                                                                                                                                                                                                                                              0.4% cached seeds germinated, includes the effects of climate and rodent foraging (Vander Wall et al., 2006, pages 539, 541) |
| `JOTR_BASE_SURVIVAL_SEEDLING`    | (0.45 + 0.31)/2 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Calculate mean of year 1 and year 2 from Esque et al (2015, page 87) |
| `JOTR_BASE_SURVIVAL_JUVENILE`    |      0.975      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Mortality of 2.5% each year (Esque et al, 2015, page 87) |
| `JOTR_BASE_SURVIVAL_ADULT`       |      0.97       |                                                                                                                                                                                                                                                                                                                                                                                                   Estimated survivorship of unburned adult plants over 4 years ~90-100%, precipitation deficits reduced survival in the 5th year to ~80%, (DeFalco et al, 2010, page 247) |
